...
function CRegistrar_unidadproductiva() {	
   ...
   $rptaTelefono = $entelefono->Insertar_telefono();
    ...
    $enunidadproductiva->setUnidadProductivaArea(validar(0));// UnidadProductivaArea es la suma de todas las areas de la parcelas :)
	...
	$enunidadproductiva->setUnidadProductivaEstado(validar("A"));
...
function CBuscarLike_unidadproductiva($ordenar,$dato){
    ...
    $rpta = $enunidadproductiva->BuscarLike_unidadproductiva(validar($ordenar),validar($dato));
    return $rpta;
}
...
function CBuscar_unidadproductiva_ProductorDNI($dni){
    $enunidadproductiva = new Clase_unidadproductiva();
	$enunidadproductiva->setProductorDni($dni);
    $rpta= $enunidadproductiva->Buscar_unidadproductiva_ProductorDNI();
    return $rpta;
}
?>