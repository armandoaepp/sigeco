...
/*
     ...
     //para Buscar Datos 
        if(isset($_POST["busca"])){ //viene del frm 
         ...
         $busca=""; }
*/
      $Listar_acopiocontrato=$cix->ImprimeTableP("tablaacopiocontrato",$data,"","",2,$page,5,"tabla");
   // $Listar_acopiocontrato=$cix->ImprimeTablePOB("tablaacopiocontrato",$data,"?","?",10,$page,5,$orden,$buscar,"tabla");
    
		echo $Listar_acopiocontrato;
break;
case "Listarsimple":
...
case "ListarLotes":
       ...
       if(isset($_GET["pagina"])){
           $page=$_GET["pagina"];}
			...
			echo "cant: ". count($data["cuerpo"]) ;

      $Listar_acopiocontrato=$cix->ImprimeTableP("tablasss",$data,"","",2,$page,5,"tabla");
