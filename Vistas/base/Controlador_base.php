...
function CListar_base_UnidadadProductivaxProrductor($idUnidadProductiva){
$enbase=new Clase_base();
$enbase->setUnidadProductivaId($idUnidadProductiva);
$rpta=$enbase->Listar_base_UnidadadProductivaxProrductor();
return $rpta;}
?>