   ...
   a.fn.jCombo = function(b, d) {
      function h(b, d, e, f, g) {
         a.ajax( {
            type : "GET", 
            dataType : "json", 
            url : d + e, success : function(a) {
               var d = ""; if(a.length == 0) {
                  d += '<option value="0"></option>'; b.html(d)}
               else {
                  if(f != "" && f != null) {
                     d += '<option value="0">' + f + "</option>"}
                  for(var e = 0; e < a.length; e++) {
                     selected = a[e][0] == g ? ' selected="selected"': ""; c = a[e]; d += '<option value="' + c[0] + '"' + selected + ">" + c[1] + "</option>"}
                  b.html(d)}
               b.trigger("change")}
            }
         )}
      ...
      if(d.parent != "") {
         ...
         function(c) {
            f.attr("disabled", 
            "disabled"); if(a(this).val() != "0" && a(this).val() != "")f.removeAttr("disabled"); h(f, 
            b, a(this).val(), d.initial_text, d.selected_value)}
         )}
