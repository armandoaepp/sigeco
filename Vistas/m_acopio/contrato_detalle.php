    ...
    <div id="cuerpoContenedor">
      ...
      <div id="contenido">
        <div id="contenidoDatos">
          <div>
            <ul class="listaLink">
              <li class="liTitulo"> Detalle de Contratos </li>
              <li class="liCancelar"> <a id="LinkCancelar" href="#">Cancelar</a></li>
              <li class="liNuevo"><a id="LinkEditar" href="#" >Editar</a></li>
              <li class="liListar"><a id="LinkListar" href="contrato.php" >Volver</a></li>
            </ul>
          </div>
                  
            <div id="divFrmActualizar"> </div>
       
        </div>
      </div>
    </div>
  </div>
  <script src="../js/js_urlVariable.js"></script> 
  <script src="../js/js_contrato_detalle.js"></script> 
</div>
</body>
</html>
