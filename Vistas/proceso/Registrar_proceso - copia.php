  ...
  <form id="frmRegistrar_proceso" name="frmRegistrar_proceso" method="post" action="<?php echo $accionf;?>">
    <table border="0" id="tablaRegistrar_proceso">
      ...
      <tr>
        ...
        <td><input type="text" name="ProcesoTiempoRecoleccion_" id="ProcesoTiempoRecoleccion_" value="<?php echo $ProcesoTiempoRecoleccion;?>"/>
          [h]</td>
      </tr>
      <tr>
        <td align="right">Tiempo de Fermentación:</td>
        <td><input type="text" name="ProcesoTiempoFermentacion_" id="ProcesoTiempoFermentacion_" value="<?php echo $ProcesoTiempoFermentacion;?>"/>
          [h]</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="ProcesoTiempoSecado_" id="ProcesoTiempoSecado_" value="<?php echo $ProcesoTiempoSecado;?>"/>
          [h]</td>
      </tr>
      <tr>
