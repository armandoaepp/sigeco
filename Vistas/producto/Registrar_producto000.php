  ...
  <form id="frmRegistrar_producto" name="frmRegistrar_producto" method="post" action="<?php echo $accionf;?>">
    <table border="0" id="tablaRegistrar_producto">
      <tr>
        ...
        <td colspan="2" align="left"><select name="TipoProductoId_" id="TipoProductoId_" class="validate[required]" >
            <?php 
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="ProductoVariedad_" id="ProductoVariedad_"  class="validate[required] text-input" /></td>
      </tr>
      <tr>
        <td align="right">&Aacute;rea:</td>
        <td width="194"><input type="text" name="ProductoArea_" id="ProductoArea_" class="validate[required] text-input" /></td>
        <td>ha</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3" class="chk"><label for="enero">
      ...
      <tr>
        ...
        <td colspan="3" class="chk"><label for="enero1">
      ...
      <tr>
        ...
        <td colspan="2"><textarea name="ProductoDescripcion_" id="ProductoDescripcion_"  rows="5"></textarea></td>
      </tr>
      <tr>
        <td ></td>
        <td align="right"><input type="submit" value="Registrar" name="btregistrar2" /></td>
        <td align="left"><input type="" value="Limpiar"/></td>
      </tr>
    </table>
  </form>
</div>
