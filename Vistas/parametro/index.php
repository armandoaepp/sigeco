...
/*
     ...
     //para Buscar Datos 
        if(isset($_POST["busca"])){ //viene del frm 
         ...
         $busca=""; }
*/
      $Listar_parametro=$cix->ImprimeTableP("tablaparametro",$data,"?","?",10,$page,5,"tabla");
   // $Listar_parametro=$cix->ImprimeTablePOB("tablaparametro",$data,"?","?",10,$page,5,$orden,$buscar,"tabla");
