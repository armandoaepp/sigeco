...
*/
	...
	$consulta=" CALL sp_CertificadoCalidadModalidad('$this->CertificadoCalidadId','$this->CertificadoCalidadVariedadTipica','$this->CertificadoCalidadVariedadCaturra','$this->CertificadoCalidadVariedadBourbon','$this->CertificadoCalidadVariedadCatimoro','$this->CertificadoCalidadTipoSecadoAlSol','$this->CertificadoCalidadTipoSecadoMecanico','$this->CertificadoCalidadAltitud','$this->CertificadoCalidadBajoSombra','$this->AcopioId')";
...
//Método Listar
public function ListarAcopio_certificadocalidad(){
	$rpta=array();
	try{
	include_once 'conexion.php';
	$con=new Conexion();
	$consulta= "SELECT * FROM certificadocalidad WHERE AcopioId='$this->AcopioId';";
	$rpta=$con->Listar($consulta);
	}catch(exception $e){
	 $rpta=$e->getMessage();}
	return $rpta;
