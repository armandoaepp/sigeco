...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Select TipoContratoId As 'TipoContratoId',TipoContrato As 'TipoContrato',TipoContratoEstado As 'Estado' from tipocontrato";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta= "select  TipoContratoId ,TipoContrato from tipocontrato order by 2 ;";
$rpta=$con->Listar($consulta);
}catch(exception $e){
 $rpta=$e->getMessage();}
return $rpta;
