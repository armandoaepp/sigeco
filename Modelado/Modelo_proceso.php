...
$con=new Conexion();
$consulta="Insert into proceso values('$this->ProcesoId','$this->ProcesoDespulpadora','$this->ProcesoTanqueTina','$this->ProcesoCompostera','$this->ProcesoTiempoRecoleccion','$this->ProcesoTiempoFermentacion','$this->ProcesoTipoFermentacion','$this->ProcesoNumeroLavado','$this->ProcesoTiempoSecado','$this->ProcesoDescripcion','$this->TipoSeleccionId','$this->TipoSecadoId','$this->ProcesoPozoInorganico','$this->ProcesoPozoMiel','$this->UnidadProductivaId')";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Select proceso.ProcesoId As 'ProcesoId',proceso.ProcesoDespulpadora As 'Despulpadora',proceso.ProcesoTanqueTina As 'TanqueTina',proceso.ProcesoCompostera As 'Compostera',proceso.ProcesoTiempoRecoleccion As 'Tiempo Recoleccion',proceso.ProcesoTiempoFermentacion As 'Tiempo Fermentacion',proceso.ProcesoTipoFermentacion As 'Tipo Fermentacion',proceso.ProcesoNumeroLavado As 'Numero Lavado',proceso.ProcesoTiempoSecado As 'Tiempo Secado',proceso.ProcesoDescripcion As 'Descripcion',proceso.TipoSeleccionId As 'Tipo Seleccion',proceso.TipoSecadoId As 'Tipo Secado',proceso.ProcesoPozoInorganico As 'Pozo Inorganico',proceso.ProcesoPozoMiel As 'Pozo Miel',proceso.UnidadProductivaId As 'UnidadProductiva' from proceso";
...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Update proceso set ProcesoDespulpadora='$this->ProcesoDespulpadora',ProcesoTanqueTina='$this->ProcesoTanqueTina',ProcesoCompostera='$this->ProcesoCompostera',ProcesoTiempoRecoleccion='$this->ProcesoTiempoRecoleccion',ProcesoTiempoFermentacion='$this->ProcesoTiempoFermentacion',ProcesoTipoFermentacion='$this->ProcesoTipoFermentacion',ProcesoNumeroLavado='$this->ProcesoNumeroLavado',ProcesoTiempoSecado='$this->ProcesoTiempoSecado',ProcesoDescripcion='$this->ProcesoDescripcion',TipoSeleccionId='$this->TipoSeleccionId',TipoSecadoId='$this->TipoSecadoId',ProcesoPozoInorganico='$this->ProcesoPozoInorganico',ProcesoPozoMiel='$this->ProcesoPozoMiel',UnidadProductivaId='$this->UnidadProductivaId' where ProcesoId='$this->ProcesoId'";
$rpta=$con->MetodoRegistrar($consulta);
...
//Método Buscar por IDunidadproductiva
public function Buscar_proceso_xUnidadProductiva(){
	$rpta=array();
	try{
	include_once 'conexion.php';
	$con=new Conexion();
	$consulta= "select p.ProcesoId, p.ProcesoDespulpadora, p.ProcesoTanqueTina, p.ProcesoCompostera, p.ProcesoTiempoRecoleccion,
 p.ProcesoTiempoFermentacion, p.ProcesoTipoFermentacion, p.ProcesoNumeroLavado, p.ProcesoTiempoSecado, p.ProcesoDescripcion 
, p.TipoSeleccionId, p.TipoSecadoId, p.ProcesoPozoInorganico, p.ProcesoPozoMiel, p.UnidadProductivaId ,
ts.TipoSecado , tsel.TipoSeleccion
 from proceso p INNER JOIN tiposecado ts ON ts.TipoSecadoId=p.TipoSecadoId
	INNER JOIN tiposeleccion tsel ON tsel.TipoSeleccionId=p.TipoSeleccionId
where UnidadProductivaId='$this->UnidadProductivaId'";
	$rpta=$con->Listar($consulta);
	//echo "Buscar_proceso_xUnidadProductiva::: $consulta ";
	}catch(exception $e){
	 $rpta=$e->getMessage();}
	return $rpta;
}
