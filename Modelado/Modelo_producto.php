...
try{ 
	...
	$con=new Conexion();
	/*
	$consulta="Insert into producto values('$this->ProductoId','$this->ProductoVariedad','$this->ProductoArea','$this->ProductoProduccionAnual','$this->ProductoMesAfloracion','$this->ProductoMesCosecha','$this->ProductoDescripcion','$this->TipoProductoId')";
*/
//ProductoId, ProductoVariedad, ProductoArea, ProductoProduccionAnual, ProductoMesAfloracion, ProductoMesCosecha, ProductoDescripcion, TipoProductoId, PeriodoId, ProductoEstado
